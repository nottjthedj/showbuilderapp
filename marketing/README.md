...
| [`_build_hub_page.py`](_build_hub_page.py) | **The production hub** — builds `production-hub.html`: the script and the prompts in film order, beat by beat, with a tick per clip and a progress bar. The page to actually work from. |
